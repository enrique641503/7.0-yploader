    ...
    try:
        ...
        if '/adduser' in msgText:
            ...
            if isadmin:
                ...
                bot.sendMessage(update.message.chat.id,'❌No Tienes Permiso❌')
            return
        ...
        if '/zips' in msgText:
            ...
            if getUser:
                try:
                   ...
                   jdb.save()
                   msg = '😃Genial desde ahora los zips seran de '+ sizeof_fmt(size*1024*1024)+' cada parte👍'
                   bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/start' in msgText:
            start_msg = 'Hola 👋. Bienvenido a 7.0 UPLOADER BOT'
            start_msg+= '👨‍💻Programado por Obisoftdev - 🛠Personalizado por @Guachineo'
            start_msg+= '🤖Bot dedicado única y exclusivamente a la subida🆙 de archivos a moodles Cubanas🇨🇺, para luego descargar estos sin ningún tipo de consumo de Datos😉'
            start_msg+= '🤷‍♂Si no está familiarizado con el uso de este tipo de Bots🤖, utilice el comando /tutorial para ver una guía🆘 resumida de los comandos disponibles✅'
            ...
            #    bot_token = '5181538678:AAH27pwzyZendM2yIuJ4UpJHxVx2CBLHpIg'
...
def main():
    ...
    #set in debug
    bot_token = '5258524528:AAFo8WU3ti_qaiVtyjf6T1EPhiUTpqULVW4'
